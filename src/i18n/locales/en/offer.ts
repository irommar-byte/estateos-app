export const offer = {
  offMarket: {
    ...
    investorProCta: 'Subscribe to Investor Pro',
  ...
  guestAsk: {
    title: 'Ask about this listing',
    subtitle: 'No account needed — leave your phone, email and a short message. The seller gets an email and a notification.',
    questionsLabel: 'Popular questions',
    qAvailable: 'Is this listing still available?',
    qViewing: 'When can I view the property?',
    qPrice: 'Is the price negotiable?',
    qMore: 'Please share more details',
    ...
    successBody: 'The seller received your message. Expect a callback.',
  ...
  detail: {
    ...
    views: {
      ...
      favoritesA11y: '{{count}} people saved this listing',
      favoritesA11yZero: 'Nobody has saved this listing yet',
      favoritesHint: 'Saved',
    },
    ...
    legalVerified: {
      ...
      tapAlertTitle: 'Security shield',
      tapAlertBody: 'Add the land registry number to send this listing for verification.',
      tapAlertCta: 'Go to KW',
    },
    openHouseMark: {
      label: 'Open house',
      a11y: 'Scheduled open house: {{date}}',
    },
    stats: {
      rooms: '{{count}} rooms',
      floor: 'Floor {{floor}}',
    ...
    ctas: {
      ...
      askListing: 'Ask about this listing',
    },
    negotiation: {
  ...
  edit: {
    ...
    gallery: {
      ...
      counter: '{{current}} / {{max}}',
      countBar: 'Photos {{used}} / {{max}}',
      spaceBar: 'Storage {{used}} / {{max}} MB',
      replace: 'Start photos from scratch',
      replaceTitle: 'New gallery',
      replaceConfirm:
        'This permanently deletes all listing photos from the server. The floor plan and 3D model stay. Continue?',
      replaceAction: 'Delete and start over',
      replaceFailed: 'Could not clear the gallery.',
    ...
    kw: {
      ...
      pendingTitle: 'Land registry check in progress',
      unverifiedTitle: 'Add land registry number — build trust',
      verifiedSub: 'Your listing shows a green badge to buyers.',
      pendingSub: 'An administrator is reviewing the land registry. The field locks after approval.',
      lockedSub: 'The land registry number is locked after a successful check.',
      unverifiedSub: 'Listings with land registry verification get 3× more interest.',
      submitFailed: 'Listing saved, but the land-registry request did not go through. Retry from the listing page.',
    ...
    alerts: {
      ...
      photoUploadFailed: 'Could not upload the photo. Check the storage limit and try again.',
