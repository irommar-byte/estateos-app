export const addOffer = {
  ...
  step5: {
    ...
    proSession: {
      ...
      priceHint: 'Photographer in Warsaw — 199 PLN (pay on site after the session).',
    ...
    floorPlan: {
      ...
      sectionLead: 'Separate floor-plan section — scan rooms with LiDAR or upload an existing plan.',
    ...
    roomScan: {
      ...
      launchHint: 'Opening the native LiDAR scanner. Live wall counts and dimensions appear at the bottom. Finish when it says you can save.',
      rescan: 'Scan again',
      usePlan: 'Use this plan',
      exportPdf: 'Export PDF',
      open3d: '3D walkthrough',
      processing: 'Preparing plan and 3D walkthrough…',
      processingHint: 'Width, length, height and area are being written into the room fields.',
      errors: {
    ...
    ai: {
      ...
      manualLabel: 'Write the description yourself',
      ...
      descriptionPlaceholder:
        'Write your listing description in your own words…',
      intros: [
