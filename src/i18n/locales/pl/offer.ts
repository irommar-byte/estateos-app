export const offer = {
  ...
  guestAsk: {
    ...
    subtitle: 'Bez konta — zostaw telefon, e-mail i krótką wiadomość. Wystawca dostanie e-mail i powiadomienie.',
    questionsLabel: 'Popularne pytania',
    qAvailable: 'Czy oferta jest nadal aktualna?',
    qViewing: 'Kiedy można obejrzeć?',
    qPrice: 'Czy cena jest do negocjacji?',
    qMore: 'Proszę o więcej informacji',
    ...
    successBody: 'Wystawca otrzymał Twoją wiadomość. Oczekuj kontaktu.',
  ...
  detail: {
    ...
    views: {
      ...
      favoritesA11y: '{{count}} osób dodało tę ofertę do ulubionych',
      favoritesA11yZero: 'Nikt jeszcze nie dodał tej oferty do ulubionych',
      favoritesHint: 'W ulubionych',
    },
    ...
    legalVerified: {
      ...
      tapAlertTitle: 'Tarcza bezpieczeństwa',
      tapAlertBody: 'Dodaj numer księgi wieczystej, aby wysłać nieruchomość do weryfikacji.',
      tapAlertCta: 'Przejdź do KW',
    },
    openHouseMark: {
      label: 'Dzień otwarty',
      a11y: 'Umówiony dzień otwartych drzwi: {{date}}',
    },
    stats: {
      rooms: '{{count}} Pokoje',
      floor: 'Piętro {{floor}}',
  ...
  edit: {
    ...
    gallery: {
      ...
      counter: '{{current}} / {{max}}',
      countBar: 'Zdjęcia {{used}} / {{max}}',
      spaceBar: 'Miejsce {{used}} / {{max}} MB',
      replace: 'Dodaj zdjęcia od nowa',
      replaceTitle: 'Nowa galeria',
      replaceConfirm:
        'To trwale usunie wszystkie zdjęcia tej oferty z serwera. Rzut i model 3D zostaną. Kontynuować?',
      replaceAction: 'Usuń i zacznij od nowa',
      replaceFailed: 'Nie udało się wyczyścić galerii.',
    ...
    kw: {
      ...
      pendingBadge: 'W TRAKCIE WERYFIKACJI',
      rejectedBadge: 'ODRZUCONA',
      verifiedTitle: 'Nieruchomość zweryfikowana',
      pendingTitle: 'Czekamy na potwierdzenie KW',
      unverifiedTitle: 'Dodaj numer KW — zwiększ zaufanie',
      verifiedSub: 'Twoja oferta wyświetla zielony znaczek dla kupujących.',
      pendingSub: 'Administrator sprawdza księgę wieczystą. Pole KW zostanie zablokowane po akceptacji.',
      lockedSub: 'Numer KW jest zablokowany po pozytywnej weryfikacji.',
      unverifiedSub: 'Nieruchomości z weryfikacją KW wzbudzają o 3× więcej zainteresowania.',
      submitFailed: 'Oferta zapisana, ale zgłoszenie KW do weryfikacji nie doszło. Spróbuj ponownie z karty oferty.',
    ...
    alerts: {
      ...
      photoUploadFailed: 'Nie udało się wgrać zdjęcia. Sprawdź limit miejsca i spróbuj ponownie.',
