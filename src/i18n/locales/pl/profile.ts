export const profile = {
  ...
  shop: {
    ...
    freeFirstSubtitle: 'Pierwsze publiczne wystawienie oferty na koncie jest bezpłatne.',
    ...
    promoSwipeHint: 'Przesuń kartę w prawo, aby zobaczyć kolejną promocję',
    ...
    footerIos:
      'Pakiet Plus (~{{price}}) opłaca publiczne wystawienie wybranego ogłoszenia na rynek na 30 dni. Nie jest to abonament ani „slot” na koncie. Pierwsze publiczne wystawienie pierwszej oferty na koncie było bezpłatne. Jeśli płatność nie zaksięgowała wystawienia, użyj Przywróć zakupy.',
    footerAndroid:
