export const addOffer = {
  ...
  step5: {
    ...
    roomScan: {
      ...
      ready: 'Gotowy',
      dimensions: 'Wymiary',
      launchRoom: 'SKAN POMIESZCZENIA',
      launchProperty: 'SKAN CAŁEJ NIERUCHOMOŚCI',
      launchHint: 'Otwieram natywny skaner LiDAR. Na dole widać na żywo ściany i wymiary. Zakończ, gdy pojawi się „Możesz zakończyć”.',
      rescan: 'Skanuj ponownie',
      usePlan: 'Użyj tego planu',
      exportPdf: 'Eksportuj PDF',
      open3d: 'Spacer 3D',
      processing: 'Przygotowuję plan i spacer 3D…',
      processingHint: 'Szerokość, długość, wysokość i metraż wstawiają się do pomieszczenia.',
      errors: {
        ...
        unsupportedDevice: 'Ten iPhone lub iPad nie ma LiDAR. Skaner RoomPlan działa na iPhonie Pro (12+) i iPadzie Pro z LiDAR. Wymiary możesz wpisać ręcznie.',
      },
      roomTypes: {
        livingRoom: 'Salon',
