export const addOffer = {
  ...
  step5: {
    ...
    roomScan: {
      ...
      launchHint: 'Открываю нативный сканер LiDAR. Снизу видно стены и размеры. Завершите, когда появится «Можно закончить».',
      rescan: 'Сканировать снова',
      usePlan: 'Использовать план',
      exportPdf: 'Экспорт PDF',
      open3d: '3D-тур',
      processing: 'Подготовка плана и 3D-тура…',
      processingHint: 'Ширина, длина, высота и площадь записываются в поля помещения.',
      errors: {
      ...
      roomTypes: {
        livingRoom: 'Гостиная',
        livingRoomKitchenette: 'Гостиная с кухней',
        bedroom: 'Спальня',
        room: 'Комната',
        bathroom: 'Ванная',
        wc: 'WC',
