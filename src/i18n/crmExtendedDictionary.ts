...
const pl: CrmExtendedDictionary = {
  ...
  archive: {
    ...
    warningBody:
      "Obecny opłacony czas emisji przepada. Aby wrócić na rynek, wymagane będzie odnowienie (24 PLN).",
    cancel: "Anuluj",
...
const en: CrmExtendedDictionary = {
  ...
  archive: {
    ...
    warningBody:
      "Remaining paid display time ends. Returning to market requires renewal (24 PLN).",
    cancel: "Cancel",
