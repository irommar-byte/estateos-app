...
function lightGoldPalette() {
  return {
    base: ['#A8781F', '#CFA748', '#E2C177', '#B0862A', '#C9A052'] as const,
    undertone: ['#9A6C16', '#C09338', '#DDBB6C', '#A87F27'] as const,
    brushLight: 'rgba(255, 246, 214, 0.68)',
    brushMid: 'rgba(226, 193, 119, 0.3)',
    brushShadow: 'rgba(74, 50, 6, 0.26)',
    glossHot: 'rgba(255, 248, 222, 0.5)',
    glossWarm: 'rgba(255, 233, 178, 0.2)',
    glossCool: 'rgba(238, 205, 140, 0.1)',
    specularCore: 'rgba(255, 250, 226, 0.52)',
    specularTail: 'rgba(238, 212, 152, 0.16)',
    rimLight: 'rgba(255, 246, 214, 0.72)',
    rimShadow: 'rgba(70, 47, 6, 0.3)',
    aoDeep: 'rgba(60, 40, 4, 0.3)',
    aoMid: 'rgba(88, 62, 14, 0.16)',
    vignette: 'rgba(70, 47, 6, 0.26)',
    edgeHighlight: 'rgba(255, 246, 214, 0.78)',
    edgeShadow: 'rgba(70, 47, 6, 0.3)',
    chromaticCool: 'rgba(255, 236, 190, 0.1)',
    chromaticWarm: 'rgba(255, 214, 150, 0.08)',
    svgHotSpot: ['rgba(255,248,222,0.5)', 'rgba(255,248,222,0)'] as const,
    svgAoBr: ['rgba(0,0,0,0)', 'rgba(60,40,4,0.35)'] as const,
    svgAoTl: ['rgba(255,246,214,0.22)', 'rgba(255,246,214,0)'] as const,
  };
}
