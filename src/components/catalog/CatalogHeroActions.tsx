...
const baseSecondary =
  "inline-flex items-center justify-center gap-2 rounded-2xl border border-[var(--eos-border)] bg-transparent px-4 py-3 text-[12px] font-semibold tracking-[-0.01em] text-[var(--eos-muted)] transition duration-200 ease-out hover:border-[var(--eos-border-strong)] hover:bg-[var(--eos-surface)] hover:text-[var(--eos-text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--eos-border-strong)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--eos-card)]";
