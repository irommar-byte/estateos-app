          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="relative">{dict.hero.ctaBuy}</span>
              </button>
              <button
              ...
              <button
                onClick={() => openHomeCta("BUY")}
                className="text-[10px] uppercase tracking-[0.24em] text-white/45 transition-colors hover:text-emerald-300 sm:text-[11px]"
              >
                {dict.hero.exploreMap}
              </button>
            </motion.div>
          </motion.div>
        </motion.div>
