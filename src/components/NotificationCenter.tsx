      ...
      ? createPortal(
          <AnimatePresence>
            ...
            >
              ...
              <div
                data-lenis-prevent
                className="max-h-[min(440px,calc(100svh-10rem))] overflow-y-auto overscroll-contain bg-[var(--eos-card)] [-webkit-overflow-scrolling:touch]"
              >
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex gap-4">
                            <div
                              className={`flex size-10 shrink-0 items-center justify-center rounded-full ${style.bg} ${style.color}`}
                            >
                            ...
                            <div className="min-w-0 flex-1">
                              <h4
                                className={`mb-1 line-clamp-1 text-sm font-bold ${
                                  notification.isRead ? "text-[var(--eos-muted)]" : "text-[var(--eos-text)]"
                                }`}
                              >
                                {notification.title}
                              </h4>
