  ...
  return (
    <AnimatePresence>
      <motion.div 
         ...
         animate={{ opacity: 1 }} 
         exit={{ opacity: 0 }} 
         className="fixed inset-0 z-[999999] flex items-start justify-center overflow-y-auto p-4 pt-10 pb-10 sm:p-6 sm:pt-20 sm:pb-20" 
         onClick={onClose}
      >
        ...
        <motion.div 
           ...
           className="eos-themed-modal relative w-full max-w-2xl overflow-hidden rounded-[2.5rem] border border-[var(--eos-border)] bg-[var(--eos-card)] shadow-[var(--eos-shadow-strong)]"
        >
           {/* Tło Modalu */}
           ...
           <div className="p-6 md:p-8 border-b border-[var(--eos-border)] flex justify-between items-start relative z-10">
              ...
              <button onClick={onClose} className="p-3 bg-[var(--eos-input)] hover:bg-red-500 hover:text-[var(--eos-text)] rounded-full transition-colors text-[var(--eos-muted)]"><X size={20}/></button>
           </div>
