...
console.log("=== TWORZENIE KOMPONENTU ESTATEOS™ WORKSPACE SWITCHER ===");
...
const switcherPath = path.join(uiDir, 'WorkspaceSwitcher.tsx');
const switcherCode = `"use client";
...
try {
  fs.writeFileSync(switcherPath, switcherCode);
  console.log("✅ Komponent utworzony: src/components/ui/WorkspaceSwitcher.tsx");
} catch (e) {
  console.error("❌ Błąd tworzenia pliku:", e.message);
}

console.log("\n=== SKANOWANIE LOKALIZACJI STAREGO NAGŁÓWKA ===");
