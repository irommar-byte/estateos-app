      ...
      <section className="space-y-6 text-[15px] leading-relaxed">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            identifiers (such as authentication tokens, device or push notification tokens where applicable),
            and similar data used to operate accounts and secure access.
          </li>
          <li>
            <strong>User content</strong> - for example: property listing content (descriptions, images,
            metadata you submit), profile information, messages and other content you choose to upload or send
            through the Services.
          </li>
          <li>
            <strong>Location</strong> - for example: approximate or precise location when you enable
            location-based features (such as map search, nearby listings, or location-enhanced discovery), as
            permitted by your device settings and applicable law.
          </li>
          <li>
            <strong>Technical and usage data</strong> - for example: IP address, device/browser type,
            diagnostic logs, and product analytics needed to maintain security, reliability, and improve the
            Services.
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            Deliver features you request (including listings, messaging, notifications, and map-related
            features);
          </li>
        ...
        <p>
          If we transfer personal information across borders, we use appropriate safeguards as required by
          applicable law.
        </p>
        ...
        <p>
          ...
          certain processing, and to data portability. You may also withdraw consent where processing is based on
          consent. To exercise rights, contact us at{' '}
          <a className="text-emerald-700 underline" href="mailto:privacy@estateos.pl">
            privacy@estateos.pl
          </a>
        ...
        <p>
          ...
          own policies. Apple may process certain data in connection with App Store distribution; see Apple’s
